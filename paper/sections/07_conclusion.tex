...
Complementarity analysis shows Pipeline~A rescues 88.3\% of DIF-SASRec
misses (Table~\ref{tab:complementarity}), and the union system achieves HR@10 of \textbf{0.9736}
(+124\% over the content-only baseline), with warm-path P50 latency of
