...
These changes collectively reduce warm-cache end-to-end search latency from 1{,}102 ms to 59 ms — an 18.6$\times$ improvement — while enabling Vietnamese-language queries that previously achieved Precision@10 $\leq 0.05$ under BLaIR.
