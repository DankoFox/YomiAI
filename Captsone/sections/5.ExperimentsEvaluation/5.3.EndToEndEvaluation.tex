...
\begin{table}[H]
\centering
\caption{Main evaluation results (100k users, $N = 99$ negatives, seed = 42).}
\label{tab:main_results}
\begin{tabular}{lcccc}
\hline
\textbf{Method} & \textbf{HR@5} & \textbf{HR@10} & \textbf{NDCG@10} & \textbf{MRR@10} \\
\hline
Random Baseline              & 0.0500 & 0.1000 & 0.0454 & —      \\
Content Baseline             & 0.3597 & 0.4346 & 0.3022 & 0.2609 \\
GRU-SeqDQN                   & 0.0519 & 0.1031 & 0.0472 & 0.0306 \\
DIF-SASRec (Pipeline B)      & 0.5877 & 0.7745 & 0.5024 & 0.4191 \\
Pipeline A (Cleora + BGE-M3) & 0.5750 & 0.9047 & 0.5393 & 0.4302 \\
System ($A \cup B$)          & —      & \textbf{0.9736} & \textbf{0.5571} & — \\
\hline
\end{tabular}
\end{table}
