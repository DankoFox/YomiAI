...
\begin{enumerate}
    ...
    \item \textbf{GRU-SeqDQN}: a recurrent reinforcement-learning approach using a GRU-based policy network trained with Deep Q-Network objectives. Represents the prior recommendation module.
    \item \textbf{DIF-SASRec (Pipeline B)}: the proposed Decoupled Information-Feature Self-Attentive Recommendation model with separate content and category attention streams.
