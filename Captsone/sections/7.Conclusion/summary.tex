...
\begin{enumerate}
    ...
    \item \textbf{Bellman-error loss sparkline as training transparency.}
    A live SVG sparkline in the right-panel profile view plots the full per-user Bellman-error loss history with an annotated phase boundary between pretraining and online fine-tuning.
