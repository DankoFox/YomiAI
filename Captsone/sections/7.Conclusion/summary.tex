...
The BLaIR text encoder, trained on (user review, item description) pairs, was optimised for matching long descriptive text rather than the short conversational queries users actually type, and it is monolingual English, so Vietnamese queries returned near-zero precision.
