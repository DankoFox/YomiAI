...
This chapter has presented the theoretical foundations and prior work underlying the proposed system.
...
The survey of existing solutions establishes a clear evolutionary line from GRU4Rec through SASRec and BERT4Rec to DIF-SASRec, and grounds the decision to replace the prior GRU-SeqDQN system with the proposed dual-mode architecture.
