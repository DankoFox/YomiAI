...
\hline
Recommendation    & GRU-SeqDQN HR@10 = 0.1031 (near random); no content feature integration; no behavioural graph signal; large action-space convergence failure & Sections~\ref{sec:infra_improvements}--\ref{sec:storage_improvements} \\
\hline
