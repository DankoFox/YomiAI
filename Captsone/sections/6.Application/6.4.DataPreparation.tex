...
Three offline pipelines must be run before the server can start for the first time.
They are executed once during setup and re-run as needed when the model or catalogue changes.
