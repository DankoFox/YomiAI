...
Skip logs a skip event (reward 0.0) without a gradient step.
...
The grey Discovery mode status pill transitions to a green DIF-SASRec active badge, and a toast notification confirms the transition.
...
The You Might Like sub-tab renders an input-sequence strip above the recommendation cards when personalised mode is active.
