...
\begin{subfigure}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/chapter6/fig_rec_pab}
...
\begin{subfigure}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/chapter6/fig_rec_yml}
    ...
    \label{fig:rec_yml}
\end{subfigure}
\caption{Personalised Recommendations (Mode 2) for a warm user. The \textit{DIF-SASRec active} status pill confirms personalised mode is engaged. (a)~Pipeline~A surfaces co-purchase neighbours re-ranked by profile similarity. (b)~Pipeline~B applies the DIF-SASRec sequential model; the input-sequence strip makes the model's click-history input visible to the user.}
\label{fig:rec_demo}
\end{figure}
