...
\begin{subfigure}{\textwidth}
    ...
    \caption{People Also Buy (Pipeline~A): BGE-M3 and CLIP cosine-similarity badges with a \textit{Cleora~+~BGE-M3} or \textit{Cleora~+~CLIP} layer tag.}
    \label{fig:rec_pab}
\end{subfigure}
...
\begin{subfigure}{\textwidth}
    ...
    \caption{You Might Like (Pipeline~B): normalised SASRec intent score with a \textit{DIF-SASRec} layer tag and the input-sequence strip above the cards.}
    \label{fig:rec_yml}
\end{subfigure}
