...
This chapter established the motivation, objectives, and scope of the capstone project.
...
Five goals were defined: pipeline design, baseline improvement, multilingual search, latency reduction, and deployment of an interactive application that demonstrates the integration of all platform components.
