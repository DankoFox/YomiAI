...
This report presents the design, implementation, and evaluation of a dual-mode multimodal book recommendation system built on a data platform with modular ingestion, storage, and retrieval components.
...
The platform is further applied to an air quality monitoring use case to demonstrate the generality of the data ingestion, visualisation, and retrieval modules across domains.
