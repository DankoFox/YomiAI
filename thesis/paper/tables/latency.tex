...
\caption{End-to-end latency for active search on an NVIDIA RTX~5060~Ti.
         ...
         LRU caches populated (30 warm-cache observations).
...
contribute ${\approx}900$\,ms P50 when the index is not resident in OS page cache.
...
entirely for repeated queries, reducing warm-path P50 to ${\approx}17$\,ms.
