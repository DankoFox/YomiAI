...
\begin{center}
    ...
    \textcolor{blue}{\textbf{\MakeUppercase{Leveraging Multimedia Data \\ for Next Best Action \\ Recommendation System}}}
    ...
    \begin{tabular}{l l}
        \textbf{COUNCIL:} & 6CC KHMT \\
        \textbf{SUPERVISOR(s):} & PhD. LE THANH VAN \\
        \textbf{REVIEWER(s):}  & PhD. DIEP THANH DANG \\
    ...
    \begin{tabular}{l l}
        \textbf{STUDENT 1:} & DANG MINH KHANG \quad -- \quad 2252287 \\
        \textbf{STUDENT 2:} & PHAM TRAN DANG KHOA \quad -- \quad 2252360 \\
        \textbf{STUDENT 3:} & LE HA NGUYEN KHANH \quad -- \quad 2252327 \\
    \end{tabular}
