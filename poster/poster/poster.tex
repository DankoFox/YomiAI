...
\definecolor{NavyTint}{HTML}{E8ECF5}
\definecolor{OrangeTint}{HTML}{FEF3E4}
...
\newenvironment{brutelist}{%
  \begin{list}{{\color{Navy}\mono\fontsize{22}{24}\selectfont❯}}{%
...
\newcolumntype{D}{>{\mono\fontsize{15}{19}\selectfont\color{TextMid}}r}
\newcolumntype{T}{>{\normalsize\color{TextDark}}l}
...
\begin{minipage}[t]{0.48\linewidth}%
  ...
  \begin{brutebox}{METHODOLOGY}
    ...
    \vspace{0.8em}
    \begin{tcolorbox}[
      enhanced, colback=BoxBg, colframe=TextMid,
      boxrule=0.5pt, arc=3pt, outer arc=3pt,
      left=4pt, right=4pt, top=4pt, bottom=4pt
    ]
      \posterfig[0.95]{Fig3.1.png}{Figure 1: Overall system architecture.}
    \end{tcolorbox}
  \end{brutebox}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.49\linewidth}%
  ...
  \begin{brutebox}{EXPERIMENTS}
    ...
    \begin{tabular}{TDDDD}
      \toprule
      \rowcolor{NavyTint}
      {\mono\color{Navy}\bfseries Method} &
      {\mono\color{Navy}\bfseries HR@5} &
      {\mono\color{Navy}\bfseries HR@10} &
      {\mono\color{Navy}\bfseries NDCG@10} &
      {\mono\color{Navy}\bfseries MRR@10} \\
      \specialrule{0.5pt}{0.15em}{0.15em}
    ...
    \begin{tcolorbox}[
      ...
      \posterfig[1.0]{fig_main_results.png}{Figure 2: HR@10 and NDCG@10 across all methods.}
    \end{tcolorbox}
  \end{brutebox}
  ...
  \begin{simplebrutebox}{WHY THE UNION WINS: PIPELINE COMPLEMENTARITY}
    {\centering
    \includegraphics[width=0.65\linewidth]{fig_complementarity.png}\par
    \vspace{0.1em}
